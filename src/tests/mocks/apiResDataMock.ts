const apiResDataMock = {
  ...
  background: 'This is a test background information.',
  season: 'Test',
  year: 2022,
  broadcast: {
    day: 'Sunday',
  ...
  external: [{ name: 'Official Site', url: 'https://test.com/official_site' }],
  streaming: [{ name: 'Test', url: 'https://test.com/test' }],
};

export default apiResDataMock;
